...
flags.DEFINE_string("project_name", "jaxrl5_safety_diffusion", "wandb project name.")
...
flags.DEFINE_boolean(
    "use_policygrad",
    False,
    "Use policy gradient for actor updates instead of Diffusion-QL.",
)
...
def main(_):
    ...
    agent = globals()[model_cls].create(
        ...
        use_policygrad=FLAGS.use_policygrad,
        **kwargs,
    )
    ...
    for step in tqdm.tqdm(
        ...
        if step < FLAGS.start_training:
            ...
            # keep RNG state inside the agent intact for diffusion sampling
