    ...
    for step in tqdm.tqdm(
        ...
        if step >= FLAGS.start_training:
            for _ in range(FLAGS.utd_ratio):
                ...
                # print("logged target_q_mean:", float(update_info["target_q_mean"]))
                # print("logged target_qh_mean:", float(update_info["target_qh_mean"]))
                # print("logged safety_critic_loss:", float(update_info["safety_critic_loss"]))
                # quit()
